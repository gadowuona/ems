...
<div class="wrapper">
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="">
                <div class="card-body">
                  ...
                  <a href ="export_data.php" class="btn btn-info" >All Members</a>
                  <a href ="export_data1.php" class="btn btn-success" >Dead Members</a>
                  <a href ="export_data2.php" class="btn btn-warning" >Members Alive</a>
                  <a href ="export_data3.php" class="btn btn-primary" >NPP Affiliate</a>
                  <a href ="export_data4.php" class="btn btn-danger" >NDC Affiliate</a>
                </div>
              </form>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <b>Developed By</b> <a href="https:annand.vercel.app/">AnnanDConsult</a>
    </div>
  </footer>
</div>
