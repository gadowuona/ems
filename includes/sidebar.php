...
if ($countResult && $countResult->num_rows > 0) {
    $totalCount = $countResult->fetch_assoc()['Total_Members'];
} else {
    $totalCount = 0;
}
?>
...
?>
    ...
    <div class="sidebar">
     ...
     <!--  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/annand.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">AnnanD Consult</a>
        </div>
      </div> -->
